...
class Building(Property):
    def __init__(self, offer: str, address: str, city: str, state: str, area: str, price: str, owner_id: str,
                 property_id: str, property_type: str, floor_number: str, elevator: str, parking="0",
    ...
    @staticmethod
    def deserialization(string_from_file: str) -> "Building":
        return Building(**json.loads(string_from_file))
    ...
    def make_object(owner_id: str) -> object:
        ...
        property_dict["property_type"] = "Building"

        floor_number = input("How many floors does the building have? ")
        ...
        if elevator == "y":
            ...
            elevator = "0"
        return Building(**property_dict, floor_number=floor_number, parking=parking, air_conditioner=air_conditioner,
