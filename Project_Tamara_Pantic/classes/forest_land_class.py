...
class ForestLand(Property):
    ...
    @staticmethod
    def deserialization(string_from_file: str) -> "ForestLand":
        return ForestLand(**json.loads(string_from_file))
    ...
    def make_object(owner_id: str) -> object:
        ...
        registered = input("Is the forest land registered? y/n: ")
        if registered == "y":
            registered = "yes"
        else:
            registered = "0"
        return ForestLand(**property_dict, registered=registered)
