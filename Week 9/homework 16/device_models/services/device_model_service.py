...
class DeviceModelsService:
    ...
    def delete_beverage_for_device_model(beverage_id: int, device_model_id: int):
        ...
        try:
            my_cursor = mydb.cursor()
            delete_beverage_for_device_model_repository = DeviceModelProducesBeverageRepository(my_cursor=my_cursor)
            delete_beverage_for_device_model_repository.delete_beverage_for_device_model(beverage_id=beverage_id,
    ...
    @staticmethod
    def get_all_device_model_ids_that_produces_beverages():
        my_cursor = mydb.cursor()
        device_model_produces_beverage_repository = DeviceModelProducesBeverageRepository(my_cursor=my_cursor)
        device_model_ids_list = device_model_produces_beverage_repository.\
            get_all_device_model_ids_that_produces_beverages()
